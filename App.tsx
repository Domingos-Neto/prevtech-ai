...
const App: React.FC = () => {
  ...
  // Notifica o sistema pai para redimensionar o container
  useEffect(() => {
  ...
  return (
    <div className="relative h-screen w-screen bg-transparent overflow-hidden flex flex-col items-end justify-end p-4">
      {/* Botão Flutuante (Bubble) - Posicionado no canto inferior direito do iframe */}
      <button 
      ...
      {/* Janela de Chat */}
      <div className={`absolute bottom-20 right-4 w-[90vw] md:w-[380px] h-[75vh] max-h-[580px] bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] flex flex-col overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] z-[9998] border border-slate-100 ${
